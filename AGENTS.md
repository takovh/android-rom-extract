...
- unblob 
- `extract_yaffs1.py` 可以用来解包 `YAFFS filesystem root entry (little endian), type root or directory, v1 root directory`（仅支持YAFFS1）
...
├── extract_yaffs1.py                   # YAFFS1 解包脚本（仅支持v1 root directory）
